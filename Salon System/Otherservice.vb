...
Public Class Otherservice
    ...
    Sub view()
        Try
            ...
            adapter.SelectCommand = New SqlCommand("select * from ServiceTable where ServiceType = 'Others'", Con)
    ...
    Private Sub Otherservice_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        view()
    End Sub
