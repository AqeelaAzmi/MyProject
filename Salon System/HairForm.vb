...
Public Class HairForm
    ...
    Sub view()
        Try
            ...
            adapter.SelectCommand = New SqlCommand("select * from ServiceTable where ServiceType = 'Hair Beauty' ", Con)
    ...
    Private Sub HairForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        view()
    End Sub
